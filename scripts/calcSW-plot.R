...
ggplot() +
    ...
    ylab("") +
    geom_histogram(data=data1, aes(x=i, y=..count.. / 100000), binwidth=0.05,
        fill="red", alpha=0.1, position="identity") +
...
ggplot() +
    ...
    geom_histogram(data=data2, aes(x=i, y=..count.. / 100000), binwidth=0.05,
        fill="blue", alpha=0.2, position="identity") +
    geom_histogram(data=data3, aes(x=i, y=..count.. / 100000), binwidth=0.05,
        fill="yellow", alpha=0.3, position="identity") +
    geom_histogram(data=data4, aes(x=i, y=..count.. / 100000), binwidth=0.05,
        fill="orange", alpha=0.4, position="identity") +
    geom_histogram(data=data5, aes(x=i, y=..count.. / 100000), binwidth=0.05,
        fill="green", alpha=0.5, position="identity") +
    geom_histogram(data=data6, aes(x=i, y=..count.. / 100000), binwidth=0.05,
        fill="purple", alpha=0.6, position="identity") +
    geom_histogram(data=data7, aes(x=i, y=..count.. / 100000), binwidth=0.05,
        fill="magenta", alpha=0.4, position="identity") +
    geom_histogram(data=data8, aes(x=i, y=..count.. / 100000), binwidth=0.05,
        fill="maroon", alpha=0.5, position="identity") +
...
ggplot() +
    ...
    xlab("Switching Point") +
    ylab("") +
    geom_histogram(data=data1, aes(x=i, y=..count.. / 100000),
        binwidth=0.05, fill="red", alpha=0.1, position="identity") +
    geom_histogram(data=data2, aes(x=i, y=..count.. / 100000),
        binwidth=0.05, fill="blue", alpha=0.2, position="identity") +
    geom_histogram(data=data3, aes(x=i, y=..count.. / 100000),
        binwidth=0.05, fill="yellow", alpha=0.3, position="identity") +
    geom_histogram(data=data4, aes(x=i, y=..count.. / 100000),
        binwidth=0.05, fill="orange", alpha=0.4, position="identity") +
    ...
    geom_histogram(data=data7, aes(x=i, y=..count.. / 100000),
        binwidth=0.05, fill="magenta", alpha=0.4, position="identity") +
    geom_histogram(data=data8, aes(x=i, y=..count.. / 100000),
        binwidth=0.05, fill="maroon", alpha=0.5, position="identity") +
